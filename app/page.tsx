      ...
      <motion.div
        ...
        >
          <div className="mt-[100px] w-full h-[100vw] flex flex-col items-center">
            ...
            <div className="w-[10%] h-[20%] bg-white"></div>
            ...
            <div className="col-span-6 row-span-2 bg-gradient-to-t from-[#3f4b67] to-[#2b3246] rounded-[2vw] p-5 flex">
              <div className="flex-1 px-5 py-20 flex flex-col">
                <div className="h-[100%] flex flex-col justify-center">
                  ...
                  <div className="text-[#99bcfe] text-[20px] font-medium">Create custom templates for different Slack channels.</div>
                </div>
                <div className=""><div className="text-gray-900 text-[15px]">25/08/2024</div></div>
              </div>
              <div className="flex-[1.5] flex justify-center items-center"><Image src={bugreport} alt="" className="shadow-2xl rounded-[1vw] w-full h-full"></Image></div>
            </div>
